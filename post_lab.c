...
{
    int plane[100] = {0}, i=0,
    firstClass=1,economy=31,choice;
    char response[2];
...
else if(economy >= 100 && firstClass<= 30)
{
...
if( !plane [firstClass] && firstClass <= 30){
printf("Your seat assignment is%d\n", firstClass);
plane[firstClass++] =1;
i++;
...
else if(firstClass >30 && economy <=100)
{
